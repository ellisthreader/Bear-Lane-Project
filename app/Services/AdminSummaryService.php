...
class AdminSummaryService
{
    public function getSummary(): array
    {
        ...
        $instantQuotes = Schema::hasTable('instant_quotes')
    ...
    private function buildActivityFeed(): array
    {
        $activityRows = collect()
            ->merge($this->buildAdminActivityRows())
            ->merge($this->buildSystemActivityRows());
    ...
    private function buildAdminActivityRows(): array
    {
        ...
        return $rows->map(function ($row) {
            ...
            return [
                'type' => (string) ($row->activity_type ?: 'admin_action'),
    ...
    private function buildSystemActivityRows(): array
    {
        $activityRows = collect();
